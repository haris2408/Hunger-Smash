...
<div class="header">
    ...
    <a href="index.php">
      ...
      <h1 style="color:white;">Kitchen Staff Menu</h1>    
...
<div class="row">
    <div class="col">
        ...
        <button class="button" onclick="window.open('http://localhost/hungersmash/pendingorders.php','_self')" >DISPLAY PENDING ORDERS</button>
        <br><br>&emsp;&emsp;&emsp;&emsp;
