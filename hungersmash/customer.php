...
<div class="header">
    ...
    <a href="index.php">
      ...
      <h1 style="color:white;">Customer Menu</h1>    
...
<div class="row">
    <div class="col">
        ...
        <button class="button" onclick="window.open('http://localhost/hungersmash/getuseridbeforeorder.php','_self')">PLACE ORDER</button>
